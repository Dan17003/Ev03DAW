package com.tecsup.ev03Mendoza.aop;


import com.tecsup.ev03Mendoza.domain.entities.Auditoria;
import com.tecsup.ev03Mendoza.domain.entities.Curso;
import com.tecsup.ev03Mendoza.domain.persistence.AuditoriaDao;
...
public class LogginAspecto {
    ...
    @Around("execution(* com.tecsup.ev03Mendoza.services.*ServiceImpl.*(..))")
    ...
    @After("execution(* com.tecsup.ev03Mendoza.controllers.*Controller.guardar*(..)) ||" +
            "execution(* com.tecsup.ev03Mendoza.controllers.*Controller.editar*(..)) ||" +
            "execution(* com.tecsup.ev03Mendoza.controllers.*Controller.eliminar*(..))")
